...
CSM_LIB_DECL void transfor_directa_p ( float x, float y, Tsc *sistema, Tpf *sol );
...
CSM_LIB_DECL void transfor_directa_pt0(float x, float y, 
			  Tsc *sistema, Tpf *sol);
...
CSM_LIB_DECL void transfor_inversa_p ( float x, float y, Tsc *sistema, Tpf *sol );
...
CSM_LIB_DECL void composicion_sis(Tsc *sis1,Tsc *sis2,Tsc *sisOut);
...
CSM_LIB_DECL void inversion_sis(Tsc *sisIn, Tsc *sisOut);
...
CSM_LIB_DECL void car2pol(Tpf *in, Tpfp *out);
...
CSM_LIB_DECL void pol2car(Tpfp *in, Tpf *out);
...
CSM_LIB_DECL int corte_segmentos ( float x1, float y1, float x2, float y2, 
		      float x3, float y3, float x4, float y4,
		      Tpf *sol );


/* Normaliza el angulo entre [-PI, PI] */
CSM_LIB_DECL float NormalizarPI(float ang);
